...
if params.get("view") == "report":
    ...
    if lab_images:
        ...
        for item in lab_images:
            if "url" in item:
                img_html += f"<div style='border: 1px solid #cbd5e1; padding: 4px; border-radius: 6px; text-align: center; background: #f8fafc;'><img src='{item['url']}' style='max-height: 110px; display: block; border-radius: 4px;'><span style='font-size: 10px; font-weight: bold; color: #334155;'>{item.get('role','Slide')}</span></div>"
        img_html += "</div></div>"
    ...
    <div class="slip-card">
        ...
        <div class="section-box">
            <strong>2. CYTOLOGY, GRADING & HISTOPATHOLOGY</strong><br>
            ...
            • <strong>Pathologist Remarks:</strong> {p['path_notes']}<br>
...
# =========================================================================
    ...
    with st.container(border=True):
        ...
        <div class="slip-card">
            ...
            <div class="advisory-box">
                <div style="font-weight: bold; text-transform: uppercase;">3. TRIAGE DIRECTIVE: {prefix}{status_banner}</div>
